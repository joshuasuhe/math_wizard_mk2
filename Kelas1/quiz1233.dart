...
import 'package:math_wizard_mk2/Kelas1/quiz1234.dart';
import 'package:random_string/random_string.dart';
import 'package:math_wizard_mk2/globals.dart' as globals;

class Quiz1233 extends StatefulWidget {
  @override
  _Quiz1233State createState() => _Quiz1233State();
}

class _Quiz1233State extends State<Quiz1233> {
  ...
  Widget build(BuildContext context) {
        List<String> soal = ["Ibu memiliki",var1.toString(), "buah cabai lalu membeli lagi", var2.toString(),"butir, jumlah cabai milik ibu adalah ... buah"];
    option1 = var1 + var2;
    option2 = var1 + var2 + 1;
    option3 = var1 + var2 - 1;
    return WillPopScope(
