...
class pilihlatihankelas3bab2 extends StatefulWidget {
  @override
  _pilihlatihankelas3bab2State createState() => _pilihlatihankelas3bab2State();
}
...
class _pilihlatihankelas3bab2State extends State<pilihlatihankelas3bab2> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            centerTitle: true,
            title: Text('BAB2 Penjumlahan & Pengurangan',
                style: TextStyle(
                    color: Colors.white,
