...
import 'package:math_wizard_mk2/Kelas1/quiz1725.dart';
import 'package:math_wizard_mk2/globals.dart' as globals;

class Quiz1724 extends StatefulWidget {
  @override
  _Quiz1724State createState() => _Quiz1724State();
}

class _Quiz1724State extends State<Quiz1724> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  ///          SOAL          ///
                  //////////////////////////////
                  Image.network("https://firebasestorage.googleapis.com/v0/b/tes1-baa07.appspot.com/o/SOAL%2FKelas1%2FBAB7_Bangun%20Datar%2Fsub3%2Fsoal22.jpg?alt=media&token=4491b85f-5cb0-41b7-af0b-505c0f9e22d4", height:200, width:200),
                  Text(
                    "Penggaris diatas berbentuk..",
                    style:
