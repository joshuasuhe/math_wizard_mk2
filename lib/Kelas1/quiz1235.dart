...
class Quiz1235 extends StatefulWidget {
  @override
  _Quiz1235State createState() => _Quiz1235State();
}

class _Quiz1235State extends State<Quiz1235> {
  ...
  var var1 = randomBetween(1, 15);
  var var2 = randomBetween(1, 15);
  var ans;
  int option1;
  int option2;
  int option3;
  ...
  Widget build(BuildContext context) {
    List<String> soal = [
      var1.toString(),
      "buah pensil ditambah",
      var2.toString(),
      "buah pensil sama dengan ... pensil"
    ];
    option1 = var1 + var2;
    option2 = var1 + var2 + 1;
    option3 = var1 + var2 - 1;
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  //////////////////////////////
                  Text(
                    "Lima apel ditambah dengan dua apel sama dengan..",
                    style:
                  ...
                  child: Column(
                    children: <Widget>[
                      MaterialButton(
                        ...
                        child: Text("Enam apel", textAlign: TextAlign.center),
                      ...
                      MaterialButton(
                        ...
                        child: Text("Tujuh apel", textAlign: TextAlign.center),
                        padding: EdgeInsets.all(5),
                        minWidth: 300,
                        height: 50,
                        color: btnColor["option"],
                      ...
                      MaterialButton(
                        ...
                        child:
                            Text("Delapan apel", textAlign: TextAlign.center),
                        padding: EdgeInsets.all(5),
                        minWidth: 300,
                        height: 50,
                        color: btnColor["option"],
