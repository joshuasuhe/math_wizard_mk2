...
import 'package:math_wizard_mk2/Kelas1/quiz1524.dart';
import 'package:random_string/random_string.dart';
import 'package:math_wizard_mk2/globals.dart' as globals;

class Quiz1523 extends StatefulWidget {
  @override
  _Quiz1523State createState() => _Quiz1523State();
}

class _Quiz1523State extends State<Quiz1523> {
  ...
  Widget build(BuildContext context) {
    List<String> soal = [
      "urutan yang benar dari angka-angka berikut dari yang paling besar adalah …"
    ];
    return WillPopScope(
