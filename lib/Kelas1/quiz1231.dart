...
import 'package:math_wizard_mk2/Kelas1/quiz1232.dart';
import 'package:random_string/random_string.dart';
import 'package:math_wizard_mk2/globals.dart' as globals;

class Quiz1231 extends StatefulWidget {
  @override
  _Quiz1231State createState() => _Quiz1231State();
}

class _Quiz1231State extends State<Quiz1231> {
  ...
  Widget build(BuildContext context) {
    List<String> soal = [var1.toString(), "jeruk ditambah", var2.toString(),"sama dengan ... jeruk"];
    option1 = var1 + var2;
    option2 = var1 + var2 + 1;
    option3 = var1 + var2 - 1;
    return Scaffold(
