...
import 'package:math_wizard_mk2/Kelas1/quiz1634.dart';
import 'package:random_string/random_string.dart';
import 'package:math_wizard_mk2/globals.dart' as globals;

class Quiz1633 extends StatefulWidget {
  @override
  _Quiz1633State createState() => _Quiz1633State();
}

class _Quiz1633State extends State<Quiz1633> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  //////////////////////////////
                 Text(
                    "Buku yang ditumpuk akan semakin..",
                    style:
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      MaterialButton(
                        ...
                        child: Text("Kecil", textAlign: TextAlign.center),
                      ...
                      MaterialButton(
                        ...
                        child: Text("Berat", textAlign: TextAlign.center),
                        padding: EdgeInsets.all(5),
                        minWidth: 300,
                        height: 50,
                        color: btnColor["option"],
                      ...
                      MaterialButton(
                        ...
                        child: Text("Ringan", textAlign: TextAlign.center),
                        padding: EdgeInsets.all(5),
                        minWidth: 300,
                        height: 50,
                        color: btnColor["option"],
