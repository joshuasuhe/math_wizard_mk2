...
import 'package:math_wizard_mk2/Kelas1/quiz1235.dart';
import 'package:random_string/random_string.dart';
import 'package:math_wizard_mk2/globals.dart' as globals;

class Quiz1234 extends StatefulWidget {
  @override
  _Quiz1234State createState() => _Quiz1234State();
}

class _Quiz1234State extends State<Quiz1234> {
  ...
  Widget build(BuildContext context) {
            List<String> soal = ["Sarah memiliki",var1.toString(), "buah jepit rambut, lalu ibu memberikan", var2.toString(),"lagi jepit rambut, jumlahnya sekarang adalah"];
    option1 = var1 + var2;
    option2 = var1 + var2 + 1;
    option3 = var1 + var2 - 1;
    return Scaffold(
