...
import 'package:math_wizard_mk2/Kelas1/quiz1233.dart';
import 'package:random_string/random_string.dart';
import 'package:math_wizard_mk2/globals.dart' as globals;

class Quiz1232 extends StatefulWidget {
  @override
  _Quiz1232State createState() => _Quiz1232State();
}

class _Quiz1232State extends State<Quiz1232> {
  ...
  Widget build(BuildContext context) {
    List<String> soal = ["Aldi memiliki",
      var1.toString(),
      "butir kelereng lalu membeli lagi",
      var2.toString(),
      "butir, jumlah kelereng Aldi adalah ... butir"
    ];
    option1 = var1 + var2;
    option2 = var1 + var2 + 1;
    option3 = var1 + var2 - 1;
