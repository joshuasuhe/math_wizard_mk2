...
class pilihlatihankelas6bab1 extends StatefulWidget {
  @override
  _pilihlatihankelas6bab1State createState() => _pilihlatihankelas6bab1State();
}

class _pilihlatihankelas6bab1State extends State<pilihlatihankelas6bab1> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            centerTitle: true,
            title: Text('BAB1 Perhitungan Bilangan Bulat',
                style: TextStyle(
                    color: Colors.white,
