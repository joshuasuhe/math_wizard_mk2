...
class pilihlatihankelas5bab3 extends StatefulWidget {
  @override
  _pilihlatihankelas5bab3State createState() => _pilihlatihankelas5bab3State();
}

class _pilihlatihankelas5bab3State extends State<pilihlatihankelas5bab3> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            centerTitle: true,
            title: Text('BAB3 Luas Bangun Datar Sederhana',
                style: TextStyle(
                    color: Colors.white,
