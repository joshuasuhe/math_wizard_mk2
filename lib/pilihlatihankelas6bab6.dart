...
class pilihlatihankelas6bab6 extends StatefulWidget {
  @override
  _pilihlatihankelas6bab6State createState() => _pilihlatihankelas6bab6State();
}

class _pilihlatihankelas6bab6State extends State<pilihlatihankelas6bab6> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            centerTitle: true,
            title: Text('BAB6 Bilangan Koordinat',
                style: TextStyle(
                    color: Colors.white,
