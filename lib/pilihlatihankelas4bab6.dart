...
class pilihlatihankelas4bab6 extends StatefulWidget {
  @override
  _pilihlatihankelas4bab6State createState() => _pilihlatihankelas4bab6State();
}

class _pilihlatihankelas4bab6State extends State<pilihlatihankelas4bab6> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            centerTitle: true,
            title: Text('BAB6 Bilangan Bulat',
                style: TextStyle(
                    color: Colors.white,
