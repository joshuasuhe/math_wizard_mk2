...
class pilihlatihankelas6bab4 extends StatefulWidget {
  @override
  _pilihlatihankelas6bab4State createState() => _pilihlatihankelas6bab4State();
}

class _pilihlatihankelas6bab4State extends State<pilihlatihankelas6bab4> {
  @override
  Widget build(BuildContext context) {
