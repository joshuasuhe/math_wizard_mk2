...
class pilihlatihankelas4bab8 extends StatefulWidget {
  @override
  _pilihlatihankelas4bab8State createState() => _pilihlatihankelas4bab8State();
}

class _pilihlatihankelas4bab8State extends State<pilihlatihankelas4bab8> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            centerTitle: true,
            title: Text('BAB8 Bilangan Romawi',
                style: TextStyle(
                    color: Colors.white,
