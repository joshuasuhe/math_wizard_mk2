...
class pilihlatihankelas4bab5 extends StatefulWidget {
  @override
  _pilihlatihankelas4bab5State createState() => _pilihlatihankelas4bab5State();
}

class _pilihlatihankelas4bab5State extends State<pilihlatihankelas4bab5> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            centerTitle: true,
            title: Text('BAB5 Segitiga & Jajargenjang',
                style: TextStyle(
                    color: Colors.white,
