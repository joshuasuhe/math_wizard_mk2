...
class pilihlatihankelas5bab2 extends StatefulWidget {
  @override
  _pilihlatihankelas5bab2State createState() => _pilihlatihankelas5bab2State();
}

class _pilihlatihankelas5bab2State extends State<pilihlatihankelas5bab2> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            centerTitle: true,
            title: Text('BAB2 Pengukuran Sudut, Waktu, Jarak & Kecepatan',
                style: TextStyle(
                    color: Colors.white,
                                  ...
                                  child: Column(
                                      ...
                                      children: <Widget>[
                                        Padding(
                                            ...
                                            child: RaisedButton(
                                                child: Text(
                                                  "Pengukuran Sudut, Waktu, Jarak & Kecepatan (1)",
                                                  style: TextStyle(
                                                      fontSize: 26.0,
                                                      fontFamily:
                                                          'Poppins-Medium',
                                  ...
                                  child: Column(
                                      ...
                                      children: <Widget>[
                                        Padding(
                                            ...
                                            child: RaisedButton(
                                                child: Text(
                                                  "Pengukuran Sudut, Waktu, Jarak & Kecepatan (2)",
                                                  style: TextStyle(
                                                      fontSize: 26.0,
                                                      fontFamily:
                                                          'Poppins-Medium',
                                  ...
                                  child: Column(
                                      ...
                                      children: <Widget>[
                                        Padding(
                                            ...
                                            child: RaisedButton(
                                                child: Text(
                                                  "Pengukuran Sudut, Waktu, Jarak & Kecepatan (3)",
                                                  style: TextStyle(
                                                      fontSize: 26.0,
                                                      fontFamily:
                                                          'Poppins-Medium',
