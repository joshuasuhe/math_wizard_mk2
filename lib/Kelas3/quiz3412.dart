...
class Quiz3412 extends StatefulWidget {
  @override
  _Quiz3412State createState() => _Quiz3412State();
}

class _Quiz3412State extends State<Quiz3412> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Rp. 7.500,00 jika dibaca adalah …"];
    option1 = "Tujuh ribu lima ratus rupiah";
    option2 = "Tujuh juta lima ratus ribu rupiah";
    option3 = "Tujuh puluh lima ribu";
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
