...
import 'package:math_wizard_mk2/Kelas3/quiz3523.dart';
import 'package:random_string/random_string.dart';
import 'package:math_wizard_mk2/globals.dart' as globals;

class Quiz3522 extends StatefulWidget {
  @override
  _Quiz3522State createState() => _Quiz3522State();
}

class _Quiz3522State extends State<Quiz3522> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Pada pukul 08.50 maka jarum panjang akan menunjuk ke arah …"];
    option1 = "10";
    option2 = "11";
    option3 = "12";
    return WillPopScope(
