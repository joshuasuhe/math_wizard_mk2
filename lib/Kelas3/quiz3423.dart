...
class Quiz3423 extends StatefulWidget {
  @override
  _Quiz3423State createState() => _Quiz3423State();
}

class _Quiz3423State extends State<Quiz3423> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Jumlah uang yang dimiliki Deni adalah …"];
    option1 = "Rp. 250.000,00";
    option2 = "Rp. 700.000,00";
    option3 = "Rp. 70.000,00";
    return WillPopScope(
