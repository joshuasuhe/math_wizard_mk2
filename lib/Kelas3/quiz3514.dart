...
class Quiz3514 extends StatefulWidget {
  @override
  _Quiz3514State createState() => _Quiz3514State();
}

class _Quiz3514State extends State<Quiz3514> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Sinta memiliki buku tulis. Ia ingin mengukur panjangnya. Maka sebaiknya ia menggunakan alat ukur berupa …."];
    option1 = "Penggaris";
    option2 = "Neraca";
    option3 = "Timbangan";
    return WillPopScope(
