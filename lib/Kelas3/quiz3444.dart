...
import 'package:math_wizard_mk2/Kelas3/quiz3445.dart';
import 'package:random_string/random_string.dart';
import 'package:math_wizard_mk2/globals.dart' as globals;

class Quiz3444 extends StatefulWidget {
  @override
  _Quiz3444State createState() => _Quiz3444State();
}

class _Quiz3444State extends State<Quiz3444> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Banu punya uang berupa 20 lembar uang lima ribuan. Uang tersebut sama nilainya dengan …."];
    option1 = "1 lembar seratus ribuan";
    option2 = "1 lembar seribuan";
    option3 = "20 lembar lima ribuan";
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
