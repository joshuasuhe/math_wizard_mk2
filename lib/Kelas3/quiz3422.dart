...
class Quiz3422 extends StatefulWidget {
  @override
  _Quiz3422State createState() => _Quiz3422State();
}

class _Quiz3422State extends State<Quiz3422> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Jumlah uang yang dimiliki Ahmad adalah …."];
