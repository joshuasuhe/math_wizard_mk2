...
class Quiz3414 extends StatefulWidget {
  @override
  _Quiz3414State createState() => _Quiz3414State();
}

class _Quiz3414State extends State<Quiz3414> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Lima belas ribu lima ratus jika ditulis dengan lambang bilangan menjadi …."];
    option1 = "Rp. 15.500,00";
    option2 = "Rp. 15.000,00";
    option3 = "Rp. 155.000,00";
    return WillPopScope(
