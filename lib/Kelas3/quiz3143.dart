...
class Quiz3143 extends StatefulWidget {
  @override
  _Quiz3143State createState() => _Quiz3143State();
}

class _Quiz3143State extends State<Quiz3143> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  //////////////////////////////
                  ///Text(
                   Text( "6 , 11 , 16 , 21 , 26", style:
                        TextStyle(fontFamily: "Poppins-Medium", fontSize: 18),
                    textAlign: TextAlign.center,
                  ),
                  Text(
                    "Barisan bilangan di atas meloncat ….", style:
                        TextStyle(fontFamily: "Poppins-Medium", fontSize: 18),
                    textAlign: TextAlign.center,
                  ),
                ],
