...
class Quiz3515 extends StatefulWidget {
  @override
  _Quiz3515State createState() => _Quiz3515State();
}

class _Quiz3515State extends State<Quiz3515> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Anita pergi ke perpustakaan selama 30 menit. Anita mengetahui banyaknya waktu ia di perpustakaan dengan menggunakan …."];
    option1 = "Jam";
    option2 = "Neraca";
    option3 = "Timbangan";
    return WillPopScope(
