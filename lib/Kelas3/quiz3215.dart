...
class Quiz3215 extends StatefulWidget {
  @override
  _Quiz3215State createState() => _Quiz3215State();
}

class _Quiz3215State extends State<Quiz3215> {
  ...
  var var2 = randomBetween(100, 200);
  var var3 = randomBetween(1, 100);
  int option1;
  int option2;
  int option3;
