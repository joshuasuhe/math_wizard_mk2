...
class Quiz3513 extends StatefulWidget {
  @override
  _Quiz3513State createState() => _Quiz3513State();
}

class _Quiz3513State extends State<Quiz3513> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Alat untuk mengukur waktu contohnya adalah …"];
    option1 = "Jam";
    option2 = "Mistar";
    option3 = "Penggaris";
    return WillPopScope(
