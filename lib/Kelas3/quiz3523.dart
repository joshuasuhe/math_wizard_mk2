...
import 'package:math_wizard_mk2/Kelas3/quiz3524.dart';
import 'package:random_string/random_string.dart';
import 'package:math_wizard_mk2/globals.dart' as globals;

class Quiz3523 extends StatefulWidget {
  @override
  _Quiz3523State createState() => _Quiz3523State();
}

class _Quiz3523State extends State<Quiz3523> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Pada pukul 05.30 maka jarum panjang akan menunjuk ke arah …"];
    option1 = "6";
    option2 = "7";
    option3 = "5";
    return WillPopScope(
