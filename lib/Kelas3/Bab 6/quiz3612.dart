...
class Quiz3612 extends StatefulWidget {
  @override
  _Quiz3612State createState() => _Quiz3612State();
}

class _Quiz3612State extends State<Quiz3612> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Pecahan tiga perdelapan di tulis …"];
    option1 = "3⁄8";
    option2 = "3 X 8";
    option3 = "8⁄3";
    return Scaffold(
