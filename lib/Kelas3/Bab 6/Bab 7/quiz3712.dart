...
class Quiz3712 extends StatefulWidget {
  @override
  _Quiz3712State createState() => _Quiz3712State();
}

class _Quiz3712State extends State<Quiz3712> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Segitiga sama kaki mempunyai sisi yang sama panjang sebanyak …"];
    option1 = "2";
    option2 = "3";
    option3 = "1";
    return Scaffold(
