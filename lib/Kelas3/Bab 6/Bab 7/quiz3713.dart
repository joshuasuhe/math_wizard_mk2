...
class Quiz3713 extends StatefulWidget {
  @override
  _Quiz3713State createState() => _Quiz3713State();
}

class _Quiz3713State extends State<Quiz3713> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Segitiga yang tidak memiliki sisi yang sama panjang dan memiliki sudut yang besarnya berbeda-beda adalah …."];
    option1 = "Segitiga sembarang";
    option2 = "Segitiga siku-siku";
    option3 = "Segitiga sama sisi";
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
