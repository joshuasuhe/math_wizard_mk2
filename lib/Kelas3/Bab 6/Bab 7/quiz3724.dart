...
class Quiz3724 extends StatefulWidget {
  @override
  _Quiz3724State createState() => _Quiz3724State();
}

class _Quiz3724State extends State<Quiz3724> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Sudut yang besarnya adalah 75° adalah termasuk sudut …"];
    option1 = "Lancip";
    option2 = "Siku-siku";
    option3 = "Tumpul";
    return Scaffold(
