...
class Quiz3714 extends StatefulWidget {
  @override
  _Quiz3714State createState() => _Quiz3714State();
}

class _Quiz3714State extends State<Quiz3714> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Bangun yang memiliki 4 sisi, 2 pasang sisi sama panjang, dan memiliki 4 sudut yang sama besar adalah …"];
    option1 = "Layang-layang";
    option2 = "Trapesium";
    option3 = "Persegi panjang";
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
