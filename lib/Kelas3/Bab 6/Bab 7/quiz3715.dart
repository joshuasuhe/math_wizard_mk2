...
class Quiz3715 extends StatefulWidget {
  @override
  _Quiz3715State createState() => _Quiz3715State();
}

class _Quiz3715State extends State<Quiz3715> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Segitiga yang mempunyai tiga sisi yang sama panjang disebut segitiga …"];
    option1 = "Segitiga sama sisi";
    option2 = "Segitiga siku-siku";
    option3 = "Segitiga sembarang";
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
