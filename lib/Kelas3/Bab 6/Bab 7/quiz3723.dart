...
class Quiz3723 extends StatefulWidget {
  @override
  _Quiz3723State createState() => _Quiz3723State();
}

class _Quiz3723State extends State<Quiz3723> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Sudut yang memiliki lebih kecil dari 90° disebut sudut …."];
    option1 = "Lancip";
    option2 = "Siku-siku";
    option3 = "Tumpul";
    return Scaffold(
