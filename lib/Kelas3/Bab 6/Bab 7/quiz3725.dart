...
class Quiz3725 extends StatefulWidget {
  @override
  _Quiz3725State createState() => _Quiz3725State();
}

class _Quiz3725State extends State<Quiz3725> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Sudut yang dibentuk oleh jarum jam pada pukul 01.00 adalah …"];
    option1 = "Lancip";
    option2 = "Siku-siku";
    option3 = "Tumpul";
    return Scaffold(
