...
class Quiz3721 extends StatefulWidget {
  @override
  _Quiz3721State createState() => _Quiz3721State();
}

class _Quiz3721State extends State<Quiz3721> {
  ...
  Widget build(BuildContext context) {
   List<String> soal = ["Sudut yang memiliki besar 90° disebut sudut …."];
    option1 = "Siku-siku";
    option2 = "Lancip";
    option3 = "Tumpul";
    return Scaffold(
