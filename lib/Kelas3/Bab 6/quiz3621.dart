...
import 'package:math_wizard_mk2/Kelas3/Bab%206/Quiz3621.dart';
...
class Quiz3621 extends StatefulWidget {
  @override
  _Quiz3621State createState() => _Quiz3621State();
}

class _Quiz3621State extends State<Quiz3621> {
  ...
  Widget build(BuildContext context) {
   List<String> soal = ["Pecahan 1⁄2 sering juga disebut …."];
    option1 = "Setengah";
    option2 = "Sepertiga";
    option3 = "Separuh";
    return Scaffold(
