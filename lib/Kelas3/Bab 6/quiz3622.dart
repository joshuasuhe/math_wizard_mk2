...
class Quiz3622 extends StatefulWidget {
  @override
  _Quiz3622State createState() => _Quiz3622State();
}

class _Quiz3622State extends State<Quiz3622> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["1⁄6 ….. 1⁄2. Tanda yang tepat untuk mengisi titik-titik di samping adalah …."];
    option1 = "<";
    option2 = ">";
    option3 = "=";
    return Scaffold(
