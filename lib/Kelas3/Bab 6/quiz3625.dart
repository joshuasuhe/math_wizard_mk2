...
class Quiz3625 extends StatefulWidget {
  @override
  _Quiz3625State createState() => _Quiz3625State();
}

class _Quiz3625State extends State<Quiz3625> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Ali mempunyai tali sepanjang 1⁄5 meter , Bayu sepanjang 1⁄5 meter , Budi sepanjang 1⁄2 meter, dan Rudi sepanjang 1⁄8 meter. Tali yang paling panjang adalah milik …."];
    option1 = "Budi";
    option2 = "Rudi";
    option3 = "Bayu";
    return Scaffold(
