...
class Quiz3814 extends StatefulWidget {
  @override
  _Quiz3814State createState() => _Quiz3814State();
}

class _Quiz3814State extends State<Quiz3814> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Rumus mencari keliling persegi panjang adalah …."];
    option1 = "Keliling = 2 x (Panjang + lebar)";
    option2 = "Keliling = 4 x (Panjang + lebar)";
    option3 = "Keliling = 4 x Panjang";
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
