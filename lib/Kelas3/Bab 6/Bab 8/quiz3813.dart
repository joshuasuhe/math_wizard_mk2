...
class Quiz3813 extends StatefulWidget {
  @override
  _Quiz3813State createState() => _Quiz3813State();
}

class _Quiz3813State extends State<Quiz3813> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Rumus mencari luas persegi adalah …."];
    option1 = "Luas = Panjang X Sisi";
    option2 = "Luas = Sisi X Sisi";
