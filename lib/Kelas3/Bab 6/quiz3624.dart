...
class Quiz3624 extends StatefulWidget {
  @override
  _Quiz3624State createState() => _Quiz3624State();
}

class _Quiz3624State extends State<Quiz3624> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Urutan yang benar pecahan di bawah ini dari yang terkecil adalah …"];
    option1 = "1⁄4 , 1⁄3 , 1⁄2 ";
    option2 = "⁄2 , 1⁄4 , 1⁄3 ";
    option3 = "1⁄2 , 1⁄3 , 1⁄4 ";
    return Scaffold(
