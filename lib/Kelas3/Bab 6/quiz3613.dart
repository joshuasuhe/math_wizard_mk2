...
class Quiz3613 extends StatefulWidget {
  @override
  _Quiz3613State createState() => _Quiz3613State();
}

class _Quiz3613State extends State<Quiz3613> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Pecahan 2⁄15 dibaca …."];
    option1 = "Dua per lima belas";
    option2 = "Dua kali lima belas";
    option3 = "Lima belas per dua";
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
