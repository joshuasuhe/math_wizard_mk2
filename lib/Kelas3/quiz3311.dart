...
class Quiz3311 extends StatefulWidget {
  @override
  _Quiz3311State createState() => _Quiz3311State();
}

class _Quiz3311State extends State<Quiz3311> {
  ...
  Widget build(BuildContext context) {
    List<String> soal = [var1.toString(), "X", var2.toString() , "= ..."];
    option1 = var1 * var2;
    option2 = var1 * var2+ 1;
    option3 = var1 * var2- 1;
    return WillPopScope(
