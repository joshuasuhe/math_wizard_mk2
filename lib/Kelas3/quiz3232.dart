...
class Quiz3232 extends StatefulWidget {
  @override
  _Quiz3232State createState() => _Quiz3232State();
}

class _Quiz3232State extends State<Quiz3232> {
  ...
  num var1 = randomBetween(150, 250);
  num var2 = randomBetween(150, 250);
  num var3 = randomBetween(150, 299);
  int option1;
  int option2;
  int option3;
