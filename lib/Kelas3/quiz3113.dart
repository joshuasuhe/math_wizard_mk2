...
import 'package:math_wizard_mk2/Kelas3/quiz3114.dart';
import 'package:random_string/random_string.dart';
import 'package:math_wizard_mk2/globals.dart' as globals;

class Quiz3113 extends StatefulWidget {
  @override
  _Quiz3113State createState() => _Quiz3113State();
}

class _Quiz3113State extends State<Quiz3113> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  //////////////////////////////
                  Text(
                    "Bilangan di bawah ini yang terletak di sebelah kanan 235  adalah ….", style:
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      MaterialButton(
                        ...
                        child: Text("234", textAlign: TextAlign.center),
                      ...
                      MaterialButton(
                        ...
                        child: Text("233", textAlign: TextAlign.center),
                        padding: EdgeInsets.all(5),
                        minWidth: 300,
                        height: 50,
                        color: btnColor["option"],
                      ...
                      MaterialButton(
                        ...
                        child: Text("236", textAlign: TextAlign.center),
                        padding: EdgeInsets.all(5),
                        minWidth: 300,
                        height: 50,
                        color: btnColor["option"],
