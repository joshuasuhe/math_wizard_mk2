...
import 'package:math_wizard_mk2/Kelas3/quiz3444.dart';
import 'package:random_string/random_string.dart';
import 'package:math_wizard_mk2/globals.dart' as globals;

class Quiz3443 extends StatefulWidget {
  @override
  _Quiz3443State createState() => _Quiz3443State();
}

class _Quiz3443State extends State<Quiz3443> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Uang Rendi berupa 4 lembar uang dua puluh ribuan sama nilainya dengan uang …."];
