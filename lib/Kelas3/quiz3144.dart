...
class Quiz3144 extends StatefulWidget {
  @override
  _Quiz3144State createState() => _Quiz3144State();
}

class _Quiz3144State extends State<Quiz3144> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  //////////////////////////////
                  Text(
                    "Diketahui barisan bilangan 1 , 7 , 13 , 19 , …. , ….",
                    style:
                        TextStyle(fontFamily: "Poppins-Medium", fontSize: 18),
                    textAlign: TextAlign.center,
                  ),
                 Text(
                    "Suku ke-6 dari barisan bilangan di atas adalah …",
                    style:
                        TextStyle(fontFamily: "Poppins-Medium", fontSize: 18),
                    textAlign: TextAlign.center,
                  )
