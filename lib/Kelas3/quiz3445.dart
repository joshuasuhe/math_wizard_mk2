...
class Quiz3445 extends StatefulWidget {
  @override
  _Quiz3445State createState() => _Quiz3445State();
}

class _Quiz3445State extends State<Quiz3445> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["5 lembar dua ribuan sama dengan.."];
    option1 = "1 lembar sepuluh ribuan";
    option2 = "2 lembar dua ribuan";
    option3 = "5 lembar lima ribuan";
    return WillPopScope(
