...
class Quiz3415 extends StatefulWidget {
  @override
  _Quiz3415State createState() => _Quiz3415State();
}

class _Quiz3415State extends State<Quiz3415> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Seratus ribu rupiah jika ditulis dengan lambang bilangan menjadi …"];
    option1 = "Rp. 100.000,00";
    option2 = "Rp. 1000.000,00";
    option3 = "Rp. 10.000,00";
    return WillPopScope(
