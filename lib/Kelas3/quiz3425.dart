...
class Quiz3425 extends StatefulWidget {
  @override
  _Quiz3425State createState() => _Quiz3425State();
}

class _Quiz3425State extends State<Quiz3425> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Jumlah uang yang paling banyak dimiliki oleh …"];
    option1 = "Deni";
    option2 = "Ahmad";
    option3 = "Riko";
    return WillPopScope(
