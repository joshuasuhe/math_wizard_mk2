...
class Quiz3525 extends StatefulWidget {
  @override
  _Quiz3525State createState() => _Quiz3525State();
}

class _Quiz3525State extends State<Quiz3525> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Pada pukul 23.00 maka jarum panjang akan menunjuk ke arah …"];
    option1 = "11";
    option2 = "12";
    option3 = "10";
    return Scaffold(
