...
import 'package:math_wizard_mk2/Kelas3/quiz3525.dart';
import 'package:random_string/random_string.dart';
import 'package:math_wizard_mk2/globals.dart' as globals;

class Quiz3524 extends StatefulWidget {
  @override
  _Quiz3524State createState() => _Quiz3524State();
}

class _Quiz3524State extends State<Quiz3524> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Pada pukul 16.00 maka jarum pendek akan menunjuk ke arah …"];
    option1 = "4";
    option2 = "3";
    option3 = "5";
    return WillPopScope(
