...
class Quiz3231 extends StatefulWidget {
  @override
  _Quiz3231State createState() => _Quiz3231State();
}

class _Quiz3231State extends State<Quiz3231> {
  ...
  num var1 = randomBetween(100, 200);
  num var2 = randomBetween(100, 200);
  num var3 = randomBetween(100, 199);
  num option1;
  num option2;
  num option3;
