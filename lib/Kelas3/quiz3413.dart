...
class Quiz3413 extends StatefulWidget {
  @override
  _Quiz3413State createState() => _Quiz3413State();
}

class _Quiz3413State extends State<Quiz3413> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Dua belas ribu rupiah jika ditulis dengan lambang bilangan menjadi …."];
    option1 = "Rp. 12.000,00";
    option2 = "Rp. 120.000,00";
    option3 = "Rp. 1.200,00";
    return WillPopScope(
