...
import 'package:math_wizard_mk2/Kelas3/quiz3235.dart';
import 'package:math_wizard_mk2/Kelas3/quiz3335.dart';
import 'package:math_wizard_mk2/Kelas3/quiz3415.dart';
import 'package:math_wizard_mk2/Kelas3/quiz3425.dart';
import 'package:random_string/random_string.dart';
import 'package:math_wizard_mk2/globals.dart' as globals;

class Quiz3424 extends StatefulWidget {
  @override
  _Quiz3424State createState() => _Quiz3424State();
}

class _Quiz3424State extends State<Quiz3424> {
  ...
  Widget build(BuildContext context) {
   ...
   List<String> soal = ["Jumlah uang yang dimiliki Riko adalah …"];
    option1 = "Rp. 8.000,00";
    option2 = "Rp. 80.000,00";
    option3 = "Rp. 800,00";
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
