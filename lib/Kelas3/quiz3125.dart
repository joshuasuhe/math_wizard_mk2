...
class Quiz3125 extends StatefulWidget {
  @override
  _Quiz3125State createState() => _Quiz3125State();
}

class _Quiz3125State extends State<Quiz3125> {
  ...
  Widget build(BuildContext context) {
   List<String> soal = ["Bilangan A terletak di antara bilangan" ,(var1-1).toString() ,"dan", (var1+1).toString(), "bilangan B terletak di antara bilangan ", (var2-1).toString() ,"dan", (var2+1).toString()," Jumlah bilangan A dan B adalah …."];
    option1 = var1 + var2;
    option2 = var1 + var2- 1;
    option3 = var1 + var2+ 1;
    return Scaffold(
