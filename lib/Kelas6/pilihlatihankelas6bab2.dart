...
class pilihlatihankelas6bab2 extends StatefulWidget {
  @override
  _pilihlatihankelas6bab2State createState() => _pilihlatihankelas6bab2State();
}

class _pilihlatihankelas6bab2State extends State<pilihlatihankelas6bab2> {
  @override
  Widget build(BuildContext context) {
