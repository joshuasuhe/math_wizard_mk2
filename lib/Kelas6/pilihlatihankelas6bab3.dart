...
class pilihlatihankelas6bab3 extends StatefulWidget {
  @override
  _pilihlatihankelas6bab3State createState() => _pilihlatihankelas6bab3State();
}

class _pilihlatihankelas6bab3State extends State<pilihlatihankelas6bab3> {
  @override
  Widget build(BuildContext context) {
