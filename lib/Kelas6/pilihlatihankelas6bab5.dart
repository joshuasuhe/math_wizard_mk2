...
class pilihlatihankelas6bab5 extends StatefulWidget {
  @override
  _pilihlatihankelas6bab5State createState() => _pilihlatihankelas6bab5State();
}

class _pilihlatihankelas6bab5State extends State<pilihlatihankelas6bab5> {
  @override
  Widget build(BuildContext context) {
