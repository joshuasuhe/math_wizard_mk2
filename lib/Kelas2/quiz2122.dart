...
class Quiz2122 extends StatefulWidget {
  @override
  _Quiz2122State createState() => _Quiz2122State();
}

class _Quiz2122State extends State<Quiz2122> {
  ...
  var var1 = randomBetween(21, 50);
  var var2 = randomBetween(1, 20);
  int option1;
  int option2;
  int option3;
