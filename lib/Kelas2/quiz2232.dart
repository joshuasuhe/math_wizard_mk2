...
import 'package:math_wizard_mk2/Kelas2/quiz2233.dart';
import 'package:random_string/random_string.dart';
import 'package:math_wizard_mk2/globals.dart' as globals;

class Quiz2232 extends StatefulWidget {
  @override
  _Quiz2232State createState() => _Quiz2232State();
}

class _Quiz2232State extends State<Quiz2232> {
...
String option3;
  ...
  Widget build(BuildContext context) {
    List<String> soal = ["Rani punya tongkat sepanjang ",var1.toString() ,"cm, Sinta punya tongkat sepanjang ",var2.toString() ,"cm, Lina unya tongkat sepanjang ", var3.toString()," cm Tongkat yang lebih panjang adalah milik …"];
    option1 = "Rani";
    option2 = "Sinta";
    option3 = "Lina";
    return WillPopScope(
