...
class Quiz2124 extends StatefulWidget {
  @override
  _Quiz2124State createState() => _Quiz2124State();
}

class _Quiz2124State extends State<Quiz2124> {
  ...
  Widget build(BuildContext context) {
    List<String> soal = [
      "Bu Sinta mempunyai",
      var1.toString(),
      "apel di tokonya. Hari ini terjual",
      var2.toString(),
      "buah apel. Jumlah buah apel Bu Sinta sekarang sisa …."
    ];
    option1 = var1 - var2;
    option2 = var1 - var2 - 1;
    option3 = var1 - var2 + 1;
