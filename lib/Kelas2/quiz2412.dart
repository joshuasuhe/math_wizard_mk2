...
import 'package:math_wizard_mk2/Kelas2/quiz2123.dart';
import 'package:math_wizard_mk2/Kelas2/quiz2133.dart';
import 'package:math_wizard_mk2/Kelas2/quiz2213.dart';
import 'package:math_wizard_mk2/Kelas2/quiz2313.dart';
import 'package:math_wizard_mk2/Kelas2/quiz2333.dart';
import 'package:math_wizard_mk2/Kelas2/quiz2413.dart';
...
class Quiz2412 extends StatefulWidget {
  @override
  _Quiz2412State createState() => _Quiz2412State();
}

class _Quiz2412State extends State<Quiz2412> {
  ...
  var var1 = randomBetween(5, 10);
  var var2 = randomBetween(5, 10);
  var var3 = randomBetween(10,20);
  int option1;
  int option2;
  int option3;
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  //////////////////////////////
                  Text(
                    "Bangun datar yang mempunyai jumlah sisi 4 buah adalah...",
                    style:
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      MaterialButton(
                        ...
                        child: Text("Lingkaran", textAlign: TextAlign.center),
                        padding: EdgeInsets.all(5),
                        minWidth: 300,
                        height: 50,
                        color: btnColor["option"],
