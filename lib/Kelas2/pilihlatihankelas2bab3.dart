...
class pilihlatihankelas2bab3 extends StatefulWidget {
  @override
  _pilihlatihankelas2bab3State createState() => _pilihlatihankelas2bab3State();
}
...
class _pilihlatihankelas2bab3State extends State<pilihlatihankelas2bab3> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            centerTitle: true,
            title: Text('BAB3 Perkalian & Pembagian',
                style: TextStyle(
                    color: Colors.white,
