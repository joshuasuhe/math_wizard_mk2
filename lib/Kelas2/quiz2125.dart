...
class Quiz2125 extends StatefulWidget {
  @override
  _Quiz2125State createState() => _Quiz2125State();
}

class _Quiz2125State extends State<Quiz2125> {
  ...
  Widget build(BuildContext context) {
    List<String> soal = [
      "Bayu punya koleksi", var1.toString()," kelereng Bayu memberikan kepada Rino sebanyak ",var2.toString() ,"kelereng Jumlah kelereng Bayu sekadang adalah …."];
        option1 = var1 - var2;
    option2 = var1 - var2 - 1;
    option3 = var1 - var2 + 1;
