...
import 'package:math_wizard_mk2/Kelas2/quiz2434.dart';
import 'package:random_string/random_string.dart';
import 'package:math_wizard_mk2/globals.dart' as globals;

class Quiz2433 extends StatefulWidget {
  @override
  _Quiz2433State createState() => _Quiz2433State();
}

class _Quiz2433State extends State<Quiz2433> {
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      MaterialButton(
                        ...
                        child: Text("Sama kaki", textAlign: TextAlign.center),
                      ...
                      MaterialButton(
                        ...
                        child: Text("Siku-siku", textAlign: TextAlign.center),
                        padding: EdgeInsets.all(5),
                        minWidth: 300,
                        height: 50,
                        color: btnColor["option"],
                      ...
                      MaterialButton(
                        ...
                        child: Text("Sama sisi", textAlign: TextAlign.center),
                        padding: EdgeInsets.all(5),
                        minWidth: 300,
                        height: 50,
                        color: btnColor["option"],
