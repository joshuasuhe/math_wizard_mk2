...
class pilihlatihankelas5bab1 extends StatefulWidget {
  @override
  _pilihlatihankelas5bab1State createState() => _pilihlatihankelas5bab1State();
}

class _pilihlatihankelas5bab1State extends State<pilihlatihankelas5bab1> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            centerTitle: true,
            title: Text('BAB1 Operasi Bilangan Bulat',
                style: TextStyle(
                    color: Colors.white,
