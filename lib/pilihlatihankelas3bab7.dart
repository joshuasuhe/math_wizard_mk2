...
class _pilihlatihankelas3bab7State extends State<pilihlatihankelas3bab7> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            ...
            centerTitle: true,
            title: Text('BAB7 Bangun Datar & Sudut',
                style: TextStyle(
                    color: Colors.white,
                                  ...
                                  child: Column(
                                      ...
                                      children: <Widget>[
                                        Padding(
                                            ...
                                            child: RaisedButton(
                                                child: Text(
                                                  "Bangun Datar & SudutBangun Datar & Sudut (1)",
                                                  style: TextStyle(
                                                      fontSize: 26.0,
                                                      fontFamily:
                                                          'Poppins-Medium',
